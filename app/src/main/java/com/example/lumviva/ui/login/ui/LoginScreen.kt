package com.example.lumviva.ui.login.ui // Define el paquete donde se encuentra esta clase.
...
fun LoginScreen(
    ...
    val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
        .requestIdToken(context.getString(com.example.lumviva.R.string.default_web_client_id)) // Solicita el ID de token.
